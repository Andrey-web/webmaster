...
$(document).ready(function () {
    ...
    $(".menu .menu-img").on({
        mouseenter: function () {
            ...
            img.src = "/web/webmaster/assets/img/menu/" + img_name + ".gif?t=" + new Date().getTime();
        ...
        mouseleave: function () {
            var $div = $(this);
            var img_name = $div.attr("data-img-name");
            var src = "/web/webmaster/assets/img/menu/" + img_name + ".png";
            $div.attr("src", src);
    ...
    //     $(style).attr('href', '/web/webmaste/web/webmaster/assets/css/colour-scheme/' + id + '.css');
    ...
    //     $(style).attr('href', '/web/webmaste/web/webmaster/assets/css/colour-scheme/' + colour_scheme + '.css');
    //     $(style).attr('data-color', colour_scheme);
    // } else {
